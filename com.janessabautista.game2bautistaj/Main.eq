...
public class Main : SEScene
{
	...
	public void initialize(SEResourceCache rsc) {
		...
		rsc.prepare_image("image1", "monster", get_scene_width()*0.5, get_scene_height()*0.5);
		rsc.prepare_image("image2", "sman", get_scene_width()*0.5, get_scene_height()*0.5);
		rsc.prepare_image("image3", "smiley", get_scene_width()*0.5, get_scene_height()*0.5);
		rsc.prepare_image("image4", "mario", get_scene_width()*0.5, get_scene_height()*0.5);
